    ...
    $( '.mobile-slidebar-menu li:has(ul)' ).doubleTapToGo();
     ...
     $('.yamm .dropdown-menu').each(function( index ) {
        ...
        submenuControll: function(options) {
            ...
            $('[data-off-canvas]   li.menu-item-has-children').prepend('<span class="submenu-controll-inner"><i class="theme-fonts-icon_close" aria-hidden="true"></i><i class="theme-fonts-icon_plus" aria-hidden="true"></i></span>');
